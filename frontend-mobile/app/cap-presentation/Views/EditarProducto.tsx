...
// ==========================================
const obtenerProducto = async (idProducto: string) => {
  try {
    setCargando(true);
    ...
    setPrecioOferta(
      ...
      producto.precio_oferta !== undefined
        ? producto.precio_oferta.toString()
        : ""
    );
...
<View style={estilos.seccion}>
  ...
  />
        ...
        >
          {cargando || subiendoImagen ? (
            ...
            <>
              ...
              <Text style={estilos.botonCrearTexto}>Editar producto</Text>
            </>
          )}
        </Pressable>
      ...
      {/* MODAL DE CATEGORÍAS */}
      <Modal animationType="slide" transparent={true} visible={modalCategoriasVisible} onRequestClose={() => setModalCategoriasVisible(false)} >
